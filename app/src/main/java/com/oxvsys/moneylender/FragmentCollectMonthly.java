 ...
 * {@link FragmentCollectMonthly.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link FragmentCollectMonthly#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentCollectMonthly extends Fragment {
     ...
     * @return A new instance of fragment FragmentCollectMonthly.
     */
    // TODO: Rename and change types and number of parameters
    public static FragmentCollectMonthly newInstance(String param1, String param2) {
        FragmentCollectMonthly fragment = new FragmentCollectMonthly();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_collect_monthly, container, false);
        //==================HARD CODED=============================================================================
...
//        selected_customer.setId("A1");
        ...
        deposit_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                selected_account.setType("monthly");
                //=========================================================================================================
...
//            }
//        });
                agent.child("monthly").child(agent_id).child(String.valueOf(String.valueOf(curr_cal.get(Calendar.MONTH) + 1) + "-" +
